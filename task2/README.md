...
## Overview
This project builds a stock price prediction workflow and evaluates how well the model tracks observed market movement.

## Features
- Prepares historical stock data for modeling
- Trains a prediction model on the available features
- Compares actual vs predicted values
- Includes price, volume, and feature-importance visualizations
